                ...
                while($art = mysqli_fetch_assoc($articles))
                {
                    ...
                    <article class="article">
                        ...
                        <div class="article__info">
                            <a href="/article.php?id=<?php echo $art['id']; ?>"><?php echo $art['title'];?></a><br>
                            <div class="article__info__meta"><small>Просмотры статьи: <?php echo $art['views'];?></small></div>
                            ...
                            <div class="article__info__preview"><?php echo mb_substr(strip_tags($art['text']), 0, 70) . ' ...';?></div>
                        </div>
                    </article>
                    <?php
                }
                ...
                while($comment = mysqli_fetch_assoc($comments))
                {
                    ...
                    <article class="article">
                        ...
                        <div class="article__info">
                            ...
                            <div class="article__info__preview"><?php echo mb_substr(strip_tags($comment['text']), 0, 70) . ' ...';?></div>
                        </div>
                    </article>
                    <?php
                }
